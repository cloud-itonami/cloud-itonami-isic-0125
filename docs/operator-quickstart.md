# Operator Quickstart — Tree- and Bush-Fruit and Nut Orchard/Grove Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0125** (`cloud-itonami-isic-0125`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0125.git
cd cloud-itonami-isic-0125
```
...
- Blueprint governor key: `berry-nut-operations-governor`
- Likely source path: `berrynutops.governor.cljc`
